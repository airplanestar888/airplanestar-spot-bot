...
function validateConfig(config, selection = {}) {
  const issues = [
    ...
    ...validateNumericRange(config, "minTrailingAgeMs", { min: 0, max: 3_600_000 }),
    ...
    ...validateNumericRange(config, "maxEntryPriceDriftPct", { min: 0, max: 0.05 }),
    ...
    ...validateNumericRange(config.autoPairRotation || {}, "refreshIntervalHours", { min: 1, max: 12 }),
    ...validateNumericRange(config.autoPairRotation || {}, "topPairs", { min: 5, max: 15 }),
